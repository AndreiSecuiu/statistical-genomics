...
* **`Final_report.pdf`**: The report which summarizes the work. It introduces simulated annealing for structure learning (theory and intuition) and it comments on the results of the simulation study. 
